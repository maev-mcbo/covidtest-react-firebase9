...
function OrderListComponent({ fname, lname, passport, cid, orderid  }) {




  return (
    <div   className="container w-full p-6 mb-5 max-w bg-white rounded-lg border border-gray-200 shadow-md  dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
